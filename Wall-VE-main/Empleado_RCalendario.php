            ...
            <li><a>Reportes</a></li>            
             ...
             <script>
                ...
                function enviarFechas(){
                    ...
                    window.location.href = "Empleado_GenRepVenta.php?desdeFecha=" + desdeFecha + "&hastaFecha=" + hastaFecha;
                    }
                    if(id==1){
                        
                        window.location.href = "Empleado_GenRepTicket.php?desdeFecha=" + desdeFecha + "&hastaFecha=" + hastaFecha;
                    }
                    if(id==2){
                    
                    window.location.href = "Empleado_GenRepAudit.php?desdeFecha=" + desdeFecha + "&hastaFecha=" + hastaFecha;
                    }
